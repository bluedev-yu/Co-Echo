...
class PlaceAdapter (val placeList: ArrayList<Places>): RecyclerView.Adapter<PlaceAdapter.CustomViewHolder>(){
    ...
    override fun onBindViewHolder(holder: PlaceAdapter.CustomViewHolder, position: Int) {
        ...
        holder.placeLocation.text = placeList.get(position).placeLocation
